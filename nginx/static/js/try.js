...
class Animator {
    ...
    _notify(e, i, a, t) {
        const s = i.listeners[t], n = i.duration;
...
class Animation {
    constructor(t, e, i, a) {
        var s = e[i], s = (a = resolve([t.to, a, s, t.from]), resolve([t.from, s, a]));
    ...
    tick(t) {
        var t = t - this._start, e = this._duration, i = this._prop, a = this._from, s = this._loop, n = this._to;
        let r;
...
class Animations {
    ...
    configure(s) {
        if (isObject(s)) {
            const n = Object.keys(defaults.animation), r = this._properties;
    ...
    _createAnimations(e, i) {
        const a = this._properties, s = [], n = e.$animations || (e.$animations = {});
        var t = Object.keys(i), r = Date.now();
        let o;
        for (o = t.length - 1; 0 <= o; --o) {
            const d = t[o];
            if ("$" !== d.charAt(0)) if ("options" === d) s.push(...this._animateOptions(e, i)); else {
                var l = i[d];
                let t = n[d];
                var h = a.get(d);
                if (t) {
...
function scaleClip(t, e) {
    var t = t && t.options || {}, i = t.reverse, a = void 0 === t.min ? e : 0, t = void 0 === t.max ? e : 0;
...
function updateStacks(t, e) {
    ...
    var s = i._stacks || (i._stacks = {}), {iScale: t, vScale: n, index: r} = a, o = t.axis, l = n.axis,
        h = getStackKey(t, n, a), d = e.length;
    let c;
    for (let t = 0; t < d; ++t) {
        const p = e[t];
        var {[o]: u, [l]: g} = p;
...
function clearStacks(t, e) {
    var i = t.controller.index, a = t.vScale && t.vScale.axis;
    if (a) for (const s of e = e || t._parsed) {
        const n = s._stacks;
...
class DatasetController {
    ...
    linkScales() {
        ...
        var i = this.getDataset(), a = (t, e, i, a) => "x" === t ? e : "r" === t ? a : i,
            s = e.xAxisID = valueOrDefault(i.xAxisID, getFirstScaleId(t, "x")),
            n = e.yAxisID = valueOrDefault(i.yAxisID, getFirstScaleId(t, "y")),
            i = e.rAxisID = valueOrDefault(i.rAxisID, getFirstScaleId(t, "r")), t = e.indexAxis,
            r = e.iAxisID = a(t, s, n, i), a = e.vAxisID = a(t, n, s, i);
    ...
    _dataCheck() {
        ...
        var e = t.data || (t.data = []), i = this._data;
    ...
    configure() {
        ...
        var e = t.datasetScopeKeys(this._type), e = t.getOptionScopes(this.getDataset(), e, !0);
    ...
    parsePrimitiveData(t, e, i, a) {
        ...
        var r = s.axis, o = n.axis, l = s.getLabels(), h = s === n;
        const d = new Array(a);
        let c, u, g;
    ...
    parseArrayData(t, e, i, a) {
        const {xScale: s, yScale: n} = t, r = new Array(a);
        let o, l, h, d;
    ...
    applyStack(t, e, i) {
        var a = this.chart, s = this._cachedMeta, n = e[t.axis];
        return applyStack({
    ...
    getMinMax(e, t) {
        ...
        const a = i._parsed;
        var s = i._sorted && e === i.iScale, n = a.length;
        const r = this._getOtherScale(e);
        var o = createStack(t, i, this.chart), l = {min: Number.POSITIVE_INFINITY, max: Number.NEGATIVE_INFINITY};
    ...
    draw() {
        var t = this._ctx, e = this.chart;
        const i = this._cachedMeta;
        var a = i.data || [], s = e.chartArea;
        const n = [];
        var r = this._drawStart || 0, o = this._drawCount || a.length - r, l = this.options.drawActiveElementsOnTop;
        let h;
    ...
    _resolveElementOptions(t, e = "default", i) {
        const a = "active" === e, s = this._cachedDataOpts;
        var n = t + "-" + e, r = s[n], o = this.enableOptionSharing && defined(i);
        if (r) return cloneIfNotShared(r, o);
        const l = this.chart.config;
        var r = l.datasetElementScopeKeys(this._type, t), h = a ? [t + "Hover", "hover", t, ""] : [t, ""],
            r = l.getOptionScopes(this.getDataset(), r), t = Object.keys(defaults.elements[t]);
    ...
    _getSharedOptions(t, e) {
        var t = this.resolveDataElementOptions(t, e), i = this._sharedOptions, a = this.getSharedOptions(t),
...
function computeFlexCategoryTraits(t, e, i, a) {
    var s = e.pixels, n = s[t];
    let r = 0 < t ? s[t - 1] : null, o = t < s.length - 1 ? s[t + 1] : null;
...
function parseFloatBar(t, e, i, a) {
    var s = i.parse(t[0], a), t = i.parse(t[1], a), a = Math.min(s, t), n = Math.max(s, t);
    let r = a, o = n;
...
function parseArrayOrPrimitive(t, e, i, a) {
    const s = t.iScale;
    var n = t.vScale, r = s.getLabels(), o = s === n;
    const l = [];
    let h, d, c, u;
...
function setBorderSkipped(t, e, i, a) {
    ...
    const n = {};
    var r, o, l, h;
    s ? !0 === s ? t.borderSkipped = {top: !0, right: !0, bottom: !0, left: !0} : ({
        start: e,
        end: r,
        reverse: o,
        top: l,
...
class BarController extends DatasetController {
    ...
    parseObjectData(t, e, i, a) {
        const {iScale: s, vScale: n} = t;
        var {xAxisKey: t = "x", yAxisKey: r = "y"} = this._parsing, o = "x" === s.axis ? t : r,
            l = "x" === n.axis ? t : r;
        const h = [];
        let d, c, u, g;
    ...
    getLabelAndValue(t) {
        ...
        var t = this.getParsed(t), a = t._custom,
    ...
    updateElements(e, i, a, s) {
        ...
        var l = o.getBasePixel(), h = o.isHorizontal(), d = this._getRuler(), {
            sharedOptions: c,
            includeOptions: u
        ...
        for (let t = i; t < i + a; t++) {
            var g = this.getParsed(t),
                ...
                f = this._calculateBarIndexPixels(t, d), m = (g._stacks || {})[o.axis];
            const v = {
                horizontal: h,
                base: p.base,
    ...
    _getStacks(t, i) {
        ...
        var a = e.getMatchingVisibleMetas(this._type).filter(t => t.controller.options.grouped), s = e.options.stacked;
        const n = [];
        for (const r of a) if ((void 0 === i || !(t => {
    ...
    _getRuler() {
        var t = this.options, e = this._cachedMeta;
        const i = e.iScale, a = [];
        let s, n;
    ...
    _calculateBarValuePixels(t) {
        ...
        var l = o._custom, h = isFloatBar(l);
    ...
    draw() {
        var t = this._cachedMeta, e = t.vScale;
        const i = t.data;
        var a = i.length;
        let s = 0;
...
class BubbleController extends DatasetController {
    ...
    getLabelAndValue(t) {
        var e = this._cachedMeta, i = this.chart.data.labels || [];
        const {xScale: a, yScale: s} = e;
        var e = this.getParsed(t), n = a.getLabelForValue(e.x), r = s.getLabelForValue(e.y), e = e._custom;
    ...
    updateElements(e, i, a, s) {
        ...
        var {sharedOptions: l, includeOptions: h} = this._getSharedOptions(i, s), d = r.axis, c = o.axis;
        for (let t = i; t < i + a; t++) {
            var u = e[t], g = !n && this.getParsed(t);
            const f = {};
...
function getRatioAndOffset(t, e, a) {
    ...
    if (e < TAU) {
        const u = t, g = u + e;
        var t = Math.cos(u), e = Math.sin(u), o = Math.cos(g), l = Math.sin(g),
            h = (t, e, i) => _angleBetween(t, u, g, !0) ? 1 : Math.max(e, e * a, i, i * a),
            d = (t, e, i) => _angleBetween(t, u, g, !0) ? -1 : Math.min(e, e * a, i, i * a), c = h(0, t, o),
            h = h(HALF_PI, e, l), t = d(PI, t, o), o = d(PI + HALF_PI, e, l);
...
class DoughnutController extends DatasetController {
    ...
    _getRotationExtents() {
        let e = TAU, i = -TAU;
        for (let t = 0; t < this.chart.data.datasets.length; ++t) if (this.chart.isDatasetVisible(t) && this.chart.getDatasetMeta(t).type === this._type) {
            const n = this.chart.getDatasetMeta(t).controller;
            var a = n._getRotation(), s = n._getCircumference();
    ...
    update(t) {
        ...
        const i = this._cachedMeta;
        var a = i.data, s = this.getMaxBorderWidth() + this.getMaxOffset(a) + this.options.spacing,
            n = Math.max((Math.min(e.width, e.height) - s) / 2, 0),
            n = Math.min(toPercentage(this.options.cutout, n), 1), r = this._getRingWeight(this.index), {
                circumference: o,
                rotation: l
            } = this._getRotationExtents(), {ratioX: l, ratioY: o, offsetX: h, offsetY: d} = getRatioAndOffset(l, o, n),
            l = (e.width - s) / l, e = (e.height - s) / o, s = Math.max(Math.min(l, e) / 2, 0),
    ...
    _circumference(t, e) {
        var i = this.options, a = this._cachedMeta, s = this._getCircumference();
    ...
    updateElements(t, e, i, a) {
        var s = "reset" === a, n = this.chart, r = n.chartArea, n = n.options.animation, o = (r.left + r.right) / 2,
            l = (r.top + r.bottom) / 2, r = s && n.animateScale, h = r ? 0 : this.innerRadius,
            d = r ? 0 : this.outerRadius, {sharedOptions: c, includeOptions: u} = this._getSharedOptions(e, a);
        let g = this._getRotation(), p;
        for (p = 0; p < e; ++p) g += this._circumference(p, s);
        for (p = e; p < e + i; ++p) {
            var f = this._circumference(p, s), m = t[p];
            const v = {
                x: o + this.offsetX,
                y: l + this.offsetY,
                startAngle: g,
    ...
    getLabelAndValue(t) {
        var e = this._cachedMeta, i = this.chart, a = i.data.labels || [],
    ...
    getMaxBorderWidth(t) {
        ...
        const i = this.chart;
        let a, s, n, r, o;
        if (!t) for (a = 0, s = i.data.datasets.length; a < s; ++a) if (i.isDatasetVisible(a)) {
...
class LineController extends DatasetController {
    ...
    updateElements(e, i, t, a) {
        ...
        var {sharedOptions: h, includeOptions: d} = this._getSharedOptions(i, a), c = n.axis, u = r.axis, {
                spanGaps: g,
                segment: p
            } = this.options, f = isNumber(g) ? g : Number.POSITIVE_INFINITY,
            m = this.chart._animationsDisabled || s || "none" === a, v = i + t, x = e.length;
    ...
    getMaxOverflow() {
        var t = this._cachedMeta, e = t.dataset, e = e.options && e.options.borderWidth || 0;
        const i = t.data || [];
...
class PolarAreaController extends DatasetController {
    ...
    getMinMax() {
        const t = this._cachedMeta, a = {min: Number.POSITIVE_INFINITY, max: Number.NEGATIVE_INFINITY};
    ...
    _updateRadius() {
        const t = this.chart;
        var e = t.chartArea, i = t.options, e = Math.min(e.right - e.left, e.bottom - e.top), e = Math.max(e / 2, 0),
    ...
    updateElements(a, t, e, s) {
        ...
        var h = l.xCenter, d = l.yCenter, c = l.getIndexAngle(0) - .5 * PI;
        let u = c, g;
        var p = 360 / this.countVisibleElements();
        for (g = 0; g < t; ++g) u += this._computeAngle(g, s, p);
        for (g = t; g < t + e; g++) {
            var f = a[g];
            let t = u, e = u + this._computeAngle(g, s, p),
...
class RadarController extends DatasetController {
    ...
    update(t) {
        const e = this._cachedMeta, i = e.dataset;
        var a = e.data || [], s = e.iScale.getLabels();
    ...
    updateElements(e, i, a, s) {
        ...
        var r = "reset" === s;
        for (let t = i; t < i + a; t++) {
            var o = e[t], l = this.resolveDataElementOptions(t, o.active ? "active" : s),
                h = n.getPointPositionForValue(t, this.getParsed(t).r), d = r ? n.xCenter : h.x,
                c = r ? n.yCenter : h.y, h = {x: d, y: c, angle: h.angle, skip: isNaN(d) || isNaN(c), options: l};
...
class ScatterController extends DatasetController {
    ...
    getLabelAndValue(t) {
        var e = this._cachedMeta, i = this.chart.data.labels || [];
        const {xScale: a, yScale: s} = e;
        var e = this.getParsed(t), n = a.getLabelForValue(e.x), e = s.getLabelForValue(e.y);
        return {label: i[t] || "", value: "(" + n + ", " + e + ")"}
    }

    update(t) {
        var e = this._cachedMeta, {data: i = []} = e, a = this.chart._animationsDisabled;
    ...
    updateElements(e, i, a, s) {
        ...
        var t = this.resolveDataElementOptions(i, s), d = this.getSharedOptions(t), c = this.includeOptions(s, d),
            u = r.axis, g = o.axis, {spanGaps: p, segment: f} = this.options,
            m = isNumber(p) ? p : Number.POSITIVE_INFINITY, v = this.chart._animationsDisabled || n || "none" === s;
        let x = 0 < i && this.getParsed(i - 1);
        for (let t = i; t < i + a; ++t) {
            var b = e[t], _ = this.getParsed(t);
            const D = v ? b : {};
            var y = isNullOrUndef(_[g]), k = D[u] = r.getPixelForValue(_[u], t),
...
function evaluateInteractionItems(t, i, e, a, s) {
    var n = t.getSortedVisibleDatasetMetas(), r = e[i];
    for (let t = 0, e = n.length; t < e; ++t) {
        var {index: o, data: l} = n[t], {lo: h, hi: d} = binarySearch(n[t], i, r, s);
        for (let t = h; t <= d; ++t) {
            var c = l[t];
            c.skip || a(c, o, t)
        }
...
function getDistanceMetricForAxis(t) {
    const a = -1 !== t.indexOf("x"), s = -1 !== t.indexOf("y");
    return function (t, e) {
        var i = a ? Math.abs(t.x - e.x) : 0, t = s ? Math.abs(t.y - e.y) : 0;
...
function getAxisItems(t, a, s, e, n) {
    const r = [], o = "x" === s ? "inXRange" : "inYRange";
    let l = !1;
...
var Interaction = {
    evaluateInteractionItems: evaluateInteractionItems, modes: {
        index(t, e, i, a) {
            var e = getRelativePosition(e, t), s = i.axis || "x", n = i.includeInvisible || !1;
            const r = i.intersect ? getIntersectItems(t, e, s, a, n) : getNearestItems(t, e, s, !1, a, n), o = [];
            ...
            var e = getRelativePosition(e, t), s = i.axis || "xy", n = i.includeInvisible || !1;
            let r = i.intersect ? getIntersectItems(t, e, s, a, n) : getNearestItems(t, e, s, !1, a, n);
            if (0 < r.length) {
                var o = r[0].datasetIndex, l = t.getDatasetMeta(o).data;
                r = [];
...
function setLayoutDims(t, e) {
    var i = buildStacks(t), {vBoxMaxWidth: a, hBoxMaxHeight: s} = e;
    let n, r, o;
    for (n = 0, r = t.length; n < r; ++n) {
        var l = (o = t[n]).box["fullSize"], h = i[o.stack], h = h && o.stackWeight / h.weight;
...
function buildLayoutBoxes(t) {
    ...
    const i = sortByWeight(filterByPosition(e, "left"), !0), a = sortByWeight(filterByPosition(e, "right")),
        s = sortByWeight(filterByPosition(e, "top"), !0);
    var n = sortByWeight(filterByPosition(e, "bottom")), r = filterDynamicPositionByAxis(e, "x"),
...
function updateDims(t, e, i, a) {
    ...
    var a = Math.max(0, e.outerWidth - getCombinedMax(r, t, "left", "right")),
        e = Math.max(0, e.outerHeight - getCombinedMax(r, t, "top", "bottom")), r = a !== t.w, o = e !== t.h;
...
var layouts = {
    addBox(t, e) {
        ...
        if (i) {
            var s = toPadding(i.options.layout.padding), n = Math.max(t - s.width, 0), r = Math.max(e - s.height, 0),
                o = buildLayoutBoxes(i.boxes);
            const d = o.vertical;
            var l = o.horizontal, h = (each(i.boxes, t => {
...
function initCanvas(t, e) {
    const i = t.style;
    var a = t.getAttribute("height"), s = t.getAttribute("width");
...
function fromNativeEvent(t, e) {
    var i = EVENT_TYPES[t.type] || t.type, {x: a, y: s} = getRelativePosition(t, e);
...
function createAttachObserver(t, e, a) {
    const s = t.canvas, i = new MutationObserver(t => {
        let e = !1;
...
class DomPlatform extends BasePlatform {
    ...
    releaseContext(t) {
        ...
        const a = i[EXPANDO_KEY].initial, e = (["height", "width"].forEach(t => {
            var e = a[t];
...
function autoSkip(i, a) {
    var s = i.options.ticks, i = determineMaxTicks(i), i = Math.min(s.maxTicksLimit || i, i),
        n = s.major.enabled ? getMajorIndices(a) : [], s = n.length, r = n[0], o = n[s - 1], l = [];
...
function determineMaxTicks(t) {
    var e = t.options.offset, i = t._tickSize(), e = t._length / i + (e ? 0 : 1), t = t._maxLength / i;
    return Math.floor(Math.min(e, t))
}

function calculateSpacing(t, e, i) {
    var t = getEvenSpacing(t), a = e.length / i;
...
function skip(t, e, i, a, s) {
    var n = valueOrDefault(a, 0), r = Math.min(valueOrDefault(s, t.length), t.length);
    let o = 0, l, h, d;
...
function getPixelForGridLine(t, e, i) {
    var a = t.ticks.length, s = Math.min(e, a - 1), n = t._startPixel, r = t._endPixel;
...
function getTitleHeight(t, e) {
    ...
    var e = toFont(t.font, e), i = toPadding(t.padding);
...
class Scale extends Element {
    ...
    getUserBounds() {
        var {_userMin: t, _userMax: e, _suggestedMin: i, _suggestedMax: a} = this,
            t = finiteOrDefault(t, Number.POSITIVE_INFINITY), e = finiteOrDefault(e, Number.NEGATIVE_INFINITY),
            i = finiteOrDefault(i, Number.POSITIVE_INFINITY), a = finiteOrDefault(a, Number.NEGATIVE_INFINITY);
        return {
    ...
    update(t, e, i) {
        var {beginAtZero: a, grace: s, ticks: n} = this.options, r = n.sampleSize,
    ...
    calculateLabelRotation() {
        var t, e, i, a, s = this.options, n = s.ticks, r = getTicksLimit(this.ticks.length, s.ticks.maxTicksLimit),
            o = n.minRotation || 0, l = n.maxRotation;
        let h = o;
    ...
    fit() {
        ...
        var e, i, a, s, n, {chart: r, options: {ticks: o, title: l, grid: h}} = this, d = this._isVisible(),
            c = this.isHorizontal();
    ...
    _calculatePadding(i, a, s, n) {
        var {ticks: {align: r, padding: o}, position: l} = this.options, h = 0 !== this.labelRotation,
            l = "top" !== l && "x" === this.axis;
        if (this.isHorizontal()) {
            var d = this.getPixelForTick(0) - this.left, c = this.right - this.getPixelForTick(this.ticks.length - 1);
            let t = 0, e = 0;
    ...
    _computeLabelSizes(t, e, i) {
        const {ctx: a, _longestTextCache: s} = this, n = [], r = [];
        ...
        garbageCollect(s, e);
        var i = n.indexOf(l), y = r.indexOf(h), k = t => ({width: n[t] || 0, height: r[t] || 0});
    ...
    _tickSize() {
        var t = this.options.ticks, e = toRadians(this.labelRotation), i = Math.abs(Math.cos(e)),
            e = Math.abs(Math.sin(e)), a = this._getLabelSizes(), t = t.autoSkipPadding || 0,
            s = a ? a.widest.width + t : 0, a = a ? a.highest.height + t : 0;
    ...
    _computeGridLineItems(t) {
        ...
        var o = s.offset, l = this.isHorizontal(), h = this.ticks.length + (o ? 1 : 0), d = getTickMarkLength(s);
        const c = [];
        ...
        "top" === n ? (v = p(this.bottom), k = this.bottom - d, D = v - u, P = p(t.top) + u, A = t.bottom) : "bottom" === n ? (v = p(this.top), P = t.top, A = p(t.bottom) - u, k = v + u, D = this.top + d) : "left" === n ? (v = p(this.right), y = this.right - d, S = v - u, M = p(t.left) + u, w = t.right) : "right" === n ? (v = p(this.left), M = t.left, w = p(t.right) - u, y = v + u, S = this.left + d) : "x" === e ? ("center" === n ? v = p((t.top + t.bottom) / 2 + .5) : isObject(n) && (m = n[f = Object.keys(n)[0]], v = p(this.chart.scales[f].getPixelForValue(m))), P = t.top, A = t.bottom, k = v + u, D = k + d) : "y" === e && ("center" === n ? v = p((t.left + t.right) / 2) : isObject(n) && (m = n[f = Object.keys(n)[0]], v = p(this.chart.scales[f].getPixelForValue(m))), y = v - u, S = y - d, M = t.left, w = t.right);
        var e = valueOrDefault(a.ticks.maxTicksLimit, h), C = Math.max(1, Math.ceil(h / e));
        for (x = 0; x < h; x += C) {
            var O = this.getContext(x), L = s.setContext(O), O = r.setContext(O), T = L.lineWidth, E = L.color,
                I = O.dash || [], O = O.dashOffset, R = L.tickWidth, F = L.tickColor, B = L.tickBorderDash || [],
                L = L.tickBorderDashOffset;
            void 0 !== (b = getPixelForGridLine(this, x, o)) && (_ = _alignPixel(i, b, T), l ? y = S = M = w = _ : k = D = P = A = _, c.push({
                tx1: y,
                ty1: k,
                tx2: S,
                ty2: D,
    ...
    _computeLabelItems(t) {
        var e = this.axis, i = this.options;
        const {position: a, ticks: s} = i;
        var n, r = this.isHorizontal(), o = this.ticks, {align: l, crossAlign: h, padding: d, mirror: c} = s,
            i = getTickMarkLength(i.grid), u = i + d, d = c ? -d : u, g = -toRadians(this.labelRotation);
        const p = [];
        ...
        for (f = 0, m = o.length; f < m; ++f) {
            ...
            var A = s.setContext(this.getContext(f)),
                ...
                O = A.color, L = A.textStrokeColor, T = A.textStrokeWidth;
            let t = _;
            r ? (x = y, "inner" === _ && (t = f === m - 1 ? this.options.reverse ? "left" : "right" : 0 === f ? this.options.reverse ? "right" : "left" : "center"), M = "top" === a ? "near" === h || 0 != g ? -D * S + S / 2 : "center" === h ? -w.highest.height / 2 - C * S + S : -w.highest.height + S / 2 : "near" === h || 0 != g ? S / 2 : "center" === h ? w.highest.height / 2 - C * S : w.highest.height - D * S, c && (M *= -1), 0 == g || A.showLabelBackdrop || (x += S / 2 * Math.sin(g))) : (b = y, M = (1 - D) * S / 2);
            let i;
            if (A.showLabelBackdrop) {
                var C = toPadding(A.backdropPadding), E = w.heights[f], I = w.widths[f];
                let t = M - C.top, e = 0 - C.left;
                switch (P) {
                    case"middle":
                        t -= E / 2;
                        break;
                ...
                i = {left: e, top: t, width: I + C.width, height: E + C.height, color: A.backdropColor}
            }
            p.push({
                label: v,
                font: k,
    ...
    _getYAxisLabelAlignment(t) {
        var {position: e, ticks: {crossAlign: i, mirror: a, padding: s}} = this.options, t = t + s,
    ...
    drawGrid(t) {
        ...
        if (e.display) for (s = 0, n = i.length; s < n; ++s) {
            var o = i[s];
            e.drawOnChartArea && r({x: o.x1, y: o.y1}, {x: o.x2, y: o.y2}, o), e.drawTicks && r({
                x: o.tx1,
                y: o.ty1
            }, {x: o.tx2, y: o.ty2}, {
                color: o.tickColor,
    ...
    drawBorder() {
        ...
        var o = t.setContext(this.getContext()), l = t.display ? o.width : 0;
        if (l) {
            var h = r.setContext(this.getContext(0)).lineWidth, d = this._borderValue;
            let t, e, i, a;
    ...
    drawLabels(t) {
        if (this.options.ticks.display) {
            var e = this.ctx, i = this._computeLabelArea(), t = (i && clipArea(e, i), this.getLabelItems(t));
            for (const o of t) {
                var a = o.options, s = o.font, n = o.label, r = o.textOffset;
    ...
    drawTitle() {
        ...
        if (a.display) {
            var n = toFont(a.font), r = toPadding(a.padding), o = a.align;
    ...
    _layers() {
        var t = this.options, e = t.ticks && t.ticks.z || 0, i = valueOrDefault(t.grid && t.grid.z, -1),
    ...
    getMatchingVisibleMetas(t) {
        var e = this.chart.getSortedVisibleDatasetMetas(), i = this.axis + "AxisID";
        const a = [];
        let s, n;
...
function routeDefaults(r, o) {
    Object.keys(o).forEach(t => {
        const e = t.split(".");
        var i = e.pop(), a = [r].concat(e).join(".");
        const s = o[t].split(".");
        var t = s.pop(), n = s.join(".");
...
class PluginService {
    ...
    _notify(t, e, i, a) {
        a = a || {};
        for (const o of t) {
            var s = o.plugin, n = s[i], r = [e, a, o.options];
    ...
    _createDescriptors(t, e) {
        var i = t && t.config, a = valueOrDefault(i.options && i.options.plugins, {}), i = allPlugins(i);
        return !1 !== a || e ? createDescriptors(t, i, a, e) : []
    }

    _notifyStateChanges(t) {
        var e = this._oldCache || [], i = this._cache,
...
function mergeScaleConfig(r, e) {
    const n = overrides[r.type] || {scales: {}}, o = e.scales || {}, l = getIndexAxis(r.type, e),
    ...
    return Object.keys(o).forEach(t => {
        ...
        var i = determineAxis(t, e, retrieveAxisFromDatasets(t, r), defaults.scales[e.type]),
            a = getDefaultScaleIDFromAxis(i, l), s = n.scales || {};
        h[t] = mergeIf(Object.create(null), [{axis: i}, e, s[i], s[a]])
    }), r.data.datasets.forEach(a => {
        var t = a.type || r.type;
        const s = a.indexAxis || getIndexAxis(t, e), n = (overrides[t] || {}).scales || {};
        Object.keys(n).forEach(t => {
            var e = getAxisFromDefaultScaleID(t, s), i = a[e + "AxisID"] || e;
...
class Chart {
    ...
    constructor(t, e) {
        ...
        var t = i.createResolver(i.chartOptionScopes(), this.getContext()),
            ...
            a = e && e.canvas, s = a && a.height, n = a && a.width;
    ...
    _resize(t, e) {
        var i = this.options, a = this.canvas, s = i.maintainAspectRatio && this.aspectRatio,
            a = this.platform.getMaximumSize(a, t, e, s), t = i.devicePixelRatio || this.platform.getDevicePixelRatio(),
    ...
    buildOrUpdateScales() {
        const o = this.options, a = o.scales, l = this.scales, h = Object.keys(l).reduce((t, e) => (t[e] = !1, t), {});
        let t = [];
        a && (t = t.concat(Object.keys(a).map(t => {
            var e = a[t], t = determineAxis(t, e), i = "r" === t, t = "x" === t;
            return {
                options: e,
            ...
            const e = t.options;
            var i = e.id, a = determineAxis(i, e), s = valueOrDefault(e.type, t.dtype);
    ...
    _updateMetasets() {
        ...
        var e = this.data.datasets.length, i = t.length;
    ...
    buildOrUpdateControllers() {
        ...
        for (this._removeUnreferencedMetasets(), a = 0, t = i.length; a < t; a++) {
            ...
            if (t.type && t.type !== n && (this._destroyDatasetMeta(a), t = this.getDatasetMeta(a)), t.type = n, t.indexAxis = s.indexAxis || getIndexAxis(n, this.options), t.order = s.order || 0, t.index = a, t.label = "" + s.label, t.visible = this.isDatasetVisible(a), t.controller) t.controller.updateIndex(a), t.controller.linkScales(); else {
    ...
    _getUniformDataChanges() {
        ...
        if (t && t.length) {
            ...
            var e = this.data.datasets.length,
                i = e => new Set(t.filter(t => t[0] === e).map((t, e) => e + "," + t.splice(1).join(","))), a = i(0);
    ...
    _updateDataset(t, e) {
        const i = this.getDatasetMeta(t), a = {meta: i, index: t, mode: e, cancelable: !0};
    ...
    draw() {
        ...
        if (this._resizeBeforeDraw && ({
            width: e,
            height: i
        } = this._resizeBeforeDraw, this._resize(e, i), this._resizeBeforeDraw = null), this.clear(), !(this.width <= 0 || this.height <= 0) && !1 !== this.notifyPlugins("beforeDraw", {cancelable: !0})) {
    ...
    _drawDataset(t) {
        var e = this.ctx, i = t._clip, a = !i.disabled, s = getDatasetArea(t) || this.chartArea;
    ...
    _updateVisibility(e, t, i) {
        const a = i ? "show" : "hide", s = this.getDatasetMeta(e), n = s.controller._resolveAnimations(void 0, a);
    ...
    bindUserEvents() {
        const i = this._listeners, a = this.platform, e = (t, e) => {
    ...
    bindResponsiveEvents() {
        ...
        const i = this._responsiveListeners, a = this.platform, t = (t, e) => {
            a.addEventListener(this, t, e), i[t] = e
        }, e = (t, e) => {
    ...
    setActiveElements(t) {
        var e = this._active || [], t = t.map(({datasetIndex: t, index: e}) => {
    ...
    _handleEvent(t, e, i) {
        var {_active: a = [], options: s} = this, n = this._getActiveElements(t, a, i, e), r = _isClickEvent(t),
...
function pathArc(t, e, i, a, s, n) {
    var {x: r, y: o, startAngle: l, pixelMargin: h, innerRadius: d} = e, c = Math.max(e.outerRadius + a + i - h, 0),
        h = 0 < d ? d + a + i + h : 0;
    let u = 0;
    var g = s - l,
        d = (a && (d = ((0 < d ? d - a : 0) + (0 < c ? c - a : 0)) / 2, u = (g - (0 != d ? g * d / (d + a) : g)) / 2), Math.max(.001, g * c - i / PI) / c),
        a = (g - d) / 2, i = l + a + u, g = s - a - u, {
            outerStart: d,
            outerEnd: l,
            innerStart: s,
            innerEnd: a
        } = parseBorderRadius$1(e, h, c, g - i), e = c - d, p = c - l, f = i + d / e, m = g - l / p, v = h + s, x = h + a,
        b = i + s / v, _ = g - a / x;
...
class ArcElement extends Element {
    ...
    inRange(t, e, i) {
        var a = this.getProps(["x", "y"], i), {angle: a, distance: t} = getAngleFromPoint(a, {
                x: t,
                y: e
            }), {
                startAngle: e,
            ...
            o = (this.options.spacing + this.options.borderWidth) / 2, r = valueOrDefault(r, i - e),
            r = TAU <= r || _angleBetween(a, e, i), a = _isBetween(t, s + o, n + o);
        return r && a
    }
...
function pathVars(t, e, i = {}) {
    var t = t.length, {start: i = 0, end: a = t - 1} = i, {start: s, end: n} = e, r = Math.max(i, s),
        o = Math.min(a, n);
    return {count: t, start: r, loop: e.loop, ilen: o < r && !(i < s && a < s || n < i && n < a) ? t + o - r : o - r}
}

function pathSegment(t, e, i, a) {
    var {points: s, options: n} = e, {count: r, start: o, loop: e, ilen: l} = pathVars(s, i, a);
...
class LineElement extends Element {
    ...
    interpolate(i, a) {
        var s = this.options, n = i[a], r = this.points, o = _boundSegments(this, {property: a, start: n, end: n});
        if (o.length) {
            const c = [], u = _getInterpolationMethod(s);
            let t, e;
...
function inRange$1(t, e, i, a) {
    var s = t.options, {[i]: t} = t.getProps([i], a);
...
class PointElement extends Element {
    ...
    inRange(t, e, i) {
        var a = this.options, {x: i, y: s} = this.getProps(["x", "y"], i);
...
function parseBorderWidth(t, e, i) {
    var a = t.options.borderWidth, t = t.borderSkipped, a = toTRBL(a);
    return {
...
function parseBorderRadius(t, e, i) {
    var a = t.getProps(["enableBorderRadius"])["enableBorderRadius"], s = t.options.borderRadius, n = toTRBLCorners(s),
        e = Math.min(e, i), i = t.borderSkipped, t = a || isObject(s);
    return {
...
function boundingRects(t) {
    var e = getBarBounds(t), i = e.right - e.left, a = e.bottom - e.top, s = parseBorderWidth(t, i / 2, a / 2),
...
function inRange(t, e, i, a) {
    var s = null === e, n = null === i, t = t && !(s && n) && getBarBounds(t, a);
...
function inflateRect(t, e, i = {}) {
    var a = t.x !== i.x ? -e : 0, s = t.y !== i.y ? -e : 0, n = (t.x + t.w !== i.x + i.w ? e : 0) - a,
...
function lttbDecimation(a, s, n, t, e) {
    ...
    for (r[l++] = a[h], d = 0; d < i - 2; d++) {
        let t = 0, e = 0, i;
        var f = Math.floor((d + 1) * o) + 1 + s, m = Math.min(Math.floor((d + 2) * o) + 1, n) + s, v = m - f;
        for (i = f; i < m; i++) t += a[i].x, e += a[i].y;
        t /= v, e /= v;
        var f = Math.floor(d * o) + 1 + s, x = Math.min(Math.floor((d + 1) * o) + 1, n) + s, {x: b, y: _} = a[h];
...
function _segments(t, e, i) {
    var a = t.segments, s = t.points, n = e.points;
    const r = [];
    for (const c of a) {
        var {start: o, end: l} = c, l = _findSegmentEnd(o, l, s), h = _getBounds(i, s[o], s[l], c.loop);
        if (e.segments) for (const u of _boundSegments(e, h)) {
...
function _pointsFromSegments(t, e) {
    ...
    return e.segments.forEach(({start: t, end: e}) => {
        ...
        t = s[t], e = s[e];
        null !== a ? (n.push({x: t.x, y: a}), n.push({x: e.x, y: a})) : null !== i && (n.push({
            x: i,
            y: t.y
        }), n.push({x: i, y: e.y}))
    }), n
...
function findPoint(t, e, i) {
    e = t.interpolate(e, i);
    if (!e) return {};
    var a = e[i], s = t.segments, n = t.points;
    let r = !1, o = !1;
    for (let t = 0; t < s.length; t++) {
        var l = s[t], h = n[l.start][i], l = n[l.end][i];
        if (_isBetween(a, h, l)) {
            r = a === h, o = a === l;
            break
        }
...
class simpleArc {
    ...
    interpolate(t) {
        var {x: e, y: i, radius: a} = this, t = t.angle;
...
function computeCircularBoundary(t) {
    const {scale: e, fill: i} = t;
    var t = e.options, a = e.getLabels().length, s = t.reverse ? e.max : e.min, n = _getTargetValue(i, e, s);
    const r = [];
...
function _drawfill(t, e, i) {
    var a = _getTarget(e), {line: e, scale: s, axis: n} = e, r = e.options, o = r.fill,
        r = r.backgroundColor, {above: o = r, below: r = r} = o || {};
...
function clipVertical(t, e, i) {
    ...
    t.beginPath();
    for (const d of a) {
        var {start: o, end: l} = d, h = s[o], o = s[_findSegmentEnd(o, l, s)];
...
function fill(e, t) {
    ...
    for ({source: o, target: l, start: h, end: d} of _segments(i, a, s)) {
        var {style: {backgroundColor: c = n} = {}} = o, u = !0 !== a,
...
function clipBounds(t, e, i) {
    var {top: e, bottom: a} = e.chart.chartArea, {property: i, start: s, end: n} = i || {};
...
var index = {
    id: "filler", afterDatasetsUpdate(t, e, i) {
        ...
        var a = "beforeDraw" === i.drawTime, s = e.getSortedVisibleDatasetMetas(), n = e.chartArea;
...
class Legend extends Element {
    ...
    fit() {
        ...
        if (i.display) {
            var s = i.labels, n = toFont(s.font), r = n.size, o = this._computeTitleHeight(), {
                boxWidth: s,
                itemHeight: l
            } = getBoxSize(s, r);
            let t, e;
    ...
    _fitRows(t, i, a, s) {
        const {ctx: n, maxWidth: r, options: {labels: {padding: o}}} = this, l = this.legendHitBoxes = [],
            h = this.lineWidths = [0], d = s + o;
        let c = t, u = (n.textAlign = "left", n.textBaseline = "middle", -1), g = -d;
    ...
    _fitCols(t, a, s, n) {
        const {ctx: r, maxHeight: e, options: {labels: {padding: o}}} = this, l = this.legendHitBoxes = [],
            h = this.columnSizes = [], d = e - t;
        let c = o, u = 0, g = 0, p = 0, f = 0;
        return this.legendItems.forEach((t, e) => {
    ...
    adjustHitBoxes() {
        if (this.options.display) {
            var i = this._computeTitleHeight(), {
                legendHitBoxes: a,
                options: {align: s, labels: {padding: n}, rtl: t}
            } = this;
            const r = getRtlAdapter(t, this.left, this.width);
            if (this.isHorizontal()) {
                let t = 0, e = _alignStartEnd(s, this.left + n, this.right - this.lineWidths[t]);
                ...
                let t = 0, e = _alignStartEnd(s, this.top + i + n, this.bottom - this.columnSizes[t].height);
    ...
    _draw() {
        const {options: u, columnSizes: g, lineWidths: p, ctx: f} = this, {align: m, labels: v} = u, x = defaults.color,
            b = getRtlAdapter(u.rtl, this.left, this.width), _ = toFont(v.font), y = v["padding"], k = _.size,
            S = k / 2;
        let D;
        this.drawTitle(), f.textAlign = b.textAlign("left"), f.textBaseline = "middle", f.lineWidth = .5, f.font = _.string;
        const {boxWidth: M, boxHeight: P, itemHeight: w} = getBoxSize(v, k), A = this.isHorizontal(),
            C = this._computeTitleHeight(), O = (D = A ? {
        ...
        this.legendItems.forEach((t, e) => {
            ...
            var i = f.measureText(t.text).width, a = b.textAlign(t.textAlign || (t.textAlign = v.textAlign)),
                i = M + S + i;
            let s = D.x, n = D.y;
            b.setWidth(this.width), A ? 0 < e && s + i + y > this.right && (n = D.y += O, D.line++, s = D.x = _alignStartEnd(m, this.left + y, this.right - p[D.line])) : 0 < e && n + O > this.bottom && (s = D.x = s + g[D.line].width + y, D.line++, n = D.y = _alignStartEnd(m, this.top + C + y, this.bottom - g[D.line].height));
            ...
            e = e, h = n, d = t, isNaN(M) || M <= 0 || isNaN(P) || P < 0 || (f.save(), r = valueOrDefault(d.lineWidth, 1), f.fillStyle = valueOrDefault(d.fillStyle, x), f.lineCap = valueOrDefault(d.lineCap, "butt"), f.lineDashOffset = valueOrDefault(d.lineDashOffset, 0), f.lineJoin = valueOrDefault(d.lineJoin, "miter"), f.lineWidth = r, f.strokeStyle = valueOrDefault(d.strokeStyle, x), f.setLineDash(valueOrDefault(d.lineDash, [])), v.usePointStyle ? (o = {
                ...
                h: P,
                radius: c
            }) : f.rect(l, o, M, P), f.fill(), 0 !== r && f.stroke()), f.restore()), s = _textX(a, s + M + S, A ? s + i : this.right, u.rtl), h = b.x(s), e = n, d = t, renderText(f, d.text, h, e + w / 2, _, {
                strikethrough: d.hidden,
                textAlign: b.textAlign(d.textAlign)
            }), A ? D.x += i + y : "string" != typeof t.text ? (c = _.lineHeight, D.y += calculateLegendItemHeight(t, c)) : D.y += O
        }), restoreTextDirection(this.ctx, u.textDirection)
    }

    drawTitle() {
        var a = this.options, s = a.title, n = toFont(s.font), r = toPadding(s.padding);
        if (s.display) {
            const h = getRtlAdapter(a.rtl, this.left, this.width), d = this.ctx;
            var o = s.position, l = n.size / 2, r = r.top + l;
    ...
    _computeTitleHeight() {
        var t = this.options.title, e = toFont(t.font), i = toPadding(t.padding);
        return t.display ? e.lineHeight + i.height : 0
    }

    _getLegendItemAt(t, e) {
        let i, a, s;
        if (_isBetween(t, this.left, this.right) && _isBetween(e, this.top, this.bottom)) for (s = this.legendHitBoxes, i = 0; i < s.length; ++i) if (a = s[i], _isBetween(t, a.left, a.left + a.width) && _isBetween(e, a.top, a.top + a.height)) return this.legendItems[i];
        return null
    }
        ...
        labels: {
            color: t => t.chart.options.color, boxWidth: 40, padding: 10, generateLabels(t) {
                ...
                return t._getSortedDatasetMetas().map(t => {
                    var e = t.controller.getStyle(s ? 0 : void 0), i = toPadding(e.borderWidth);
                    return {
...
function getTooltipSize(t, e) {
    const i = t.chart.ctx, {body: a, footer: s, title: n} = t;
    var {boxWidth: r, boxHeight: o} = e, l = toFont(e.bodyFont), h = toFont(e.titleFont), d = toFont(e.footerFont),
        c = n.length, u = s.length, g = a.length, p = toPadding(e.padding);
    let f = p.height, m = 0;
    ...
    }), x = 0, i.font = d.string, each(t.footer, b), i.restore(), {width: m += p.width, height: f}
}
...
function doesNotFitWithAlign(t, e, i, a) {
    var {x: a, width: s} = a, i = i.caretSize + i.caretPadding;
    return "left" === t && a + s + i > e.width || ("right" === t && a - s - i < 0 || void 0)
}

function determineXAlign(t, e, i, a) {
    var {x: s, width: n} = i, {width: r, chartArea: {left: o, right: l}} = t;
    let h = "center";
...
function getBackgroundPoint(t, e, i, a) {
    var {caretSize: t, caretPadding: s, cornerRadius: n} = t, {xAlign: i, yAlign: r} = i, s = t + s, {
        topLeft: n,
        topRight: o,
        bottomLeft: l,
        bottomRight: h
...
class Tooltip extends Element {
    ...
    _resolveAnimations() {
        ...
        if (t) return t;
        var t = this.chart, e = this.options.setContext(this.getContext()),
            t = e.enabled && t.options.animation && e.animations, e = new Animations(this.chart, t);
    ...
    getTitle(t, e) {
        var e = e["callbacks"], i = invokeCallbackWithFallback(e, "beforeTitle", this, t),
            a = invokeCallbackWithFallback(e, "title", this, t),
            e = invokeCallbackWithFallback(e, "afterTitle", this, t), t = pushOrConcat([], splitNewlines(i));
    ...
    getBody(t, e) {
        const a = e["callbacks"], s = [];
        return each(t, t => {
            var e = {before: [], lines: [], after: []}, i = overrideCallbacks(a, t);
    ...
    getFooter(t, e) {
        var e = e["callbacks"], i = invokeCallbackWithFallback(e, "beforeFooter", this, t),
            a = invokeCallbackWithFallback(e, "footer", this, t),
            e = invokeCallbackWithFallback(e, "afterFooter", this, t), t = pushOrConcat([], splitNewlines(i));
        return t = pushOrConcat(t, splitNewlines(a)), pushOrConcat(t, splitNewlines(e))
    }

    _createItems(a) {
        var t = this._active;
        const s = this.chart.data, i = [], n = [], r = [];
        let e = [], o, l;
    ...
    update(t, e) {
        ...
        r.length ? (r = positioners[i.position].call(this, r, this._eventPosition), l = this._createItems(i), this.title = this.getTitle(l, i), this.beforeBody = this.getBeforeBody(l, i), this.body = this.getBody(l, i), this.afterBody = this.getAfterBody(l, i), this.footer = this.getFooter(l, i), a = this._size = getTooltipSize(this, i), n = Object.assign({}, r, a), s = determineAlignment(this.chart, i, n), n = getBackgroundPoint(i, n, s, this.chart), this.xAlign = s.xAlign, this.yAlign = s.yAlign, o = {
            ...
            caretX: r.x,
            caretY: r.y
        }) : 0 !== this.opacity && (o = {opacity: 0}), this._tooltipItems = l, this.$context = void 0, o && this._resolveAnimations().update(this, o), t && i.external && i.external.call(this, {
            chart: this.chart,
            tooltip: this,
            replay: e
        })
    ...
    getCaretPosition(t, e, i) {
        var {xAlign: a, yAlign: s} = this, {caretSize: i, cornerRadius: n} = i, {
            topLeft: n,
            topRight: r,
            bottomLeft: o,
            bottomRight: l
        } = toTRBLCorners(n), {x: t, y: h} = t, {width: e, height: d} = e;
        let c, u, g, p, f, m;
    ...
    _drawColorBox(t, e, i, a, s) {
        var n, r = this.labelColors[i], o = this.labelPointStyles[i], {boxHeight: l, boxWidth: h} = s,
            d = toFont(s.bodyFont), c = getAlignedX(this, "left", s), c = a.x(c),
            d = l < d.lineHeight ? (d.lineHeight - l) / 2 : 0, e = e.y + d;
        s.usePointStyle ? (d = {
    ...
    drawBackground(t, e, i, a) {
        var {xAlign: s, yAlign: n} = this, {x: r, y: o} = t, {width: l, height: h} = i, {
            topLeft: d,
            topRight: c,
            bottomLeft: u,
            bottomRight: g
    ...
    setActiveElements(t, e) {
        var i = this._active, t = t.map(({datasetIndex: t, index: e}) => {
            var i = this.chart.getDatasetMeta(t);
            if (i) return {datasetIndex: t, element: i.data[e], index: e};
            throw new Error("Cannot find a dataset at index " + t)
        }), i = !_elementsEqual(i, t), a = this._positionChanged(t, e);
    ...
    handleEvent(t, e, i = !0) {
        ...
        var a = this.options, s = this._active || [], i = this._getActiveElements(t, s, e, i),
            n = this._positionChanged(i, t), s = e || !_elementsEqual(i, s) || n;
    ...
    _positionChanged(t, e) {
        var {caretX: i, caretY: a, options: s} = this, s = positioners[s.position].call(this, t, e);
...
var plugin_tooltip = {
    ...
    afterDraw(t) {
        const e = t.tooltip;
        var i;
        e && e._willRender() && (!(i = {tooltip: e}) !== t.notifyPlugins("beforeTooltipDraw", {
            ...i,
            cancelable: !0
...
class CategoryScale extends Scale {
    ...
    buildTicks() {
        var e = this.min, i = this.max, t = this.options.offset;
        const a = [];
...
function generateTicks$1(t, e) {
    ...
    var {bounds: a, step: s, min: n, max: r, precision: o, count: l, maxTicks: h, maxDigits: d, includeBounds: c} = t,
        u = s || 1, g = h - 1, {min: e, max: p} = e, f = !isNullOrUndef(n), m = !isNullOrUndef(r),
        v = !isNullOrUndef(l), d = (p - e) / (d + 1);
...
class LinearScale extends LinearScaleBase {
    ...
    computeTickLimit() {
        var t = this.isHorizontal(), e = t ? this.width : this.height, i = toRadians(this.options.ticks.minRotation),
            t = (t ? Math.sin(i) : Math.cos(i)) || .001, i = this._resolveTickFontOptions(0);
...
function generateTicks(t, {min: e, max: i}) {
    ...
    const a = [];
    var s = log10Floor(e);
    let n = startExp(e, i), r = n < 0 ? Math.pow(10, Math.abs(n)) : 1;
    var o = Math.pow(10, n), l = s > n ? Math.pow(10, s) : 0, s = Math.round((e - l) * r) / r,
...
function determineLimits(t, e, i, a, s) {
    return t === a || t === s ? {start: e - i / 2, end: e + i / 2} : t < a || s < t ? {
        start: e - i,
        end: e
    } : {start: e, end: e + i}
}
...
function fitWithPointLabels(e) {
    ...
    for (let t = 0; t < r; t++) {
        var h = o.setContext(e.getPointLabelContext(t)),
            d = (n[t] = h.padding, e.getPointPosition(t, e.drawingArea + n[t], l)), h = toFont(h.font),
            h = measureLabelSize(e.ctx, h, e._pointLabels[t]), c = (s[t] = h, _normalizeAngle(e.getIndexAngle(t) + l)),
...
function updateLimits(t, e, i, a, s) {
    var n = Math.abs(Math.sin(i)), i = Math.abs(Math.cos(i));
    let r = 0, o = 0;
...
function createPointLabelItem(t, e, i) {
    var a = t.drawingArea, {extra: i, additionalAngle: s, padding: n, size: r} = i,
        t = t.getPointPosition(e, a + i + n, s), e = Math.round(toDegrees(_normalizeAngle(t.angle + HALF_PI))),
        a = yForAngle(t.y, r.h, e), i = getTextAlignForAngle(e), n = leftForTextAlign(t.x, r.w, i);
...
function isNotOverlapped(t, e) {
    ...
    return !(_isPointInArea({x: t, y: i}, e) || _isPointInArea({x: t, y: s}, e) || _isPointInArea({
        x: a,
        y: i
    }, e) || _isPointInArea({x: a, y: s}, e))
}

function buildPointLabelItems(e, i, a) {
    const s = [];
    var n = e._pointLabels.length, t = e.options, {centerPointLabels: r, display: o} = t.pointLabels;
...
function pathRadiusLine(e, i, t, a) {
    const s = e["ctx"];
    if (t) s.arc(e.xCenter, e.yCenter, i, 0, TAU); else {
...
function drawRadiusLine(t, e, i, a, s) {
    const n = t.ctx;
    var r = e.circular, {color: e, lineWidth: o} = e;
...
class RadialLinearScale extends LinearScaleBase {
    ...
    getIndexAngle(t) {
        var e = TAU / (this._pointLabels.length || 1), i = this.options.startAngle || 0;
    ...
    drawGrid() {
        ...
        if (e.pointLabels.display && drawPointLabels(this, n), a.display && this.ticks.forEach((t, e) => {
            ...
            for (t.save(), r = n - 1; 0 <= r; r--) {
                var h = i.setContext(this.getPointLabelContext(r)), {color: d, lineWidth: c} = h;
    ...
    drawLabels() {
        const r = this.ctx, o = this.options, l = o.ticks;
        if (l.display) {
...
function parse(t, e) {
    ...
    const i = t._adapter, {parser: a, round: s, isoWeekday: n} = t._parseOpts;
    let r = e;
...
function determineUnitForAutoTicks(e, i, a, s) {
    ...
    for (let t = UNITS.indexOf(e); t < n - 1; ++t) {
        var r = INTERVALS[UNITS[t]], o = r.steps || Number.MAX_SAFE_INTEGER;
...
function setMajorTicks(t, e, i, a) {
    const s = t._adapter;
    var t = +s.startOf(e[0].value, a), n = e[e.length - 1].value;
    let r, o;
...
class TimeScale extends Scale {
    ...
    buildTicks() {
        var t = this.options, e = t.time, i = t.ticks,
    ...
    _generate() {
        ...
        var e = this.min, i = this.max, a = this.options, s = a.time,
            n = s.unit || determineUnitForAutoTicks(s.minUnit, e, i, this._getLabelCapacity(e)),
            r = valueOrDefault(a.ticks.stepSize, 1), s = "week" === n && s.isoWeekday, o = isNumber(s) || !0 === s,
            l = {};
        let h = e, d, c;
        ...
        return d !== i && "ticks" !== a.bounds && 1 !== c || addTick(l, d, u), Object.keys(l).sort((t, e) => t - e).map(t => +t)
    }
    ...
    format(t, e) {
        var i = this.options.time.displayFormats, a = this._unit, e = e || i[a];
        return this._adapter.format(t, e)
    }

    _tickFormatFunction(t, e, i, a) {
        var s = this.options, n = s.ticks.callback;
        if (n) return callback(n, [t, e, i], this);
        var n = s.time.displayFormats, s = this._unit, r = this._majorUnit, s = s && n[s], n = r && n[r], i = i[e],
            e = r && n && i && i.major;
    ...
    _getLabelSize(t) {
        var e = this.options.ticks, t = this.ctx.measureText(t).width,
            e = toRadians(this.isHorizontal() ? e.maxRotation : e.minRotation), i = Math.cos(e), e = Math.sin(e),
            a = this._resolveTickFontOptions(0).size;
        return {w: t * i + a * e, h: t * e + a * i}
    }

    _getLabelCapacity(t) {
        var e = this.options.time, i = e.displayFormats, e = i[e.unit] || i.millisecond,
            i = this._tickFormatFunction(t, 0, ticksFromTimestamps(this, [t], this._majorUnit), e),
            t = this._getLabelSize(i), e = Math.floor(this.isHorizontal() ? this.width / t.w : this.height / t.h) - 1;
        return 0 < e ? e : 1
    }
...
function interpolate(t, e, i) {
    ...
    i ? (e >= t[a].pos && e <= t[s].pos && ({lo: a, hi: s} = _lookupByKey(t, "pos", e)), {
        pos: n,
        time: o
    } = t[a], {pos: r, time: l} = t[s]) : (e >= t[a].time && e <= t[s].time && ({
        lo: a,
        hi: s
    } = _lookupByKey(t, "time", e)), {time: n, pos: o} = t[a], {time: r, pos: l} = t[s]);
    i = r - n;
